      ...
      <div className="fixed bottom-[calc(env(safe-area-inset-bottom)+1rem)] right-4 z-40 sm:right-6">
        {!isOpen && !location.startsWith("/admin") && (
          <button
            ...
            className="flex h-14 w-14 max-h-14 max-w-14 items-center justify-center rounded-full bg-indigo-600 text-white shadow-xl transition-transform hover:bg-indigo-700 hover:scale-105"
          >
        ...
        {isOpen && (
          <div className="bg-white rounded-2xl shadow-2xl w-[350px] max-w-[calc(100vw-2rem)] flex flex-col h-[min(500px,calc(100svh-7rem))] border border-stone-100 overflow-hidden">
